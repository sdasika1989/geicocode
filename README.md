...
public class Geico 
{
	...
	public static void main(String[] args) throws Exception 
	{
		...
		OpenExcel.setExcelFile("C://Users//satish//Downloads//selenium-java-2.53.0//erw.xlsx","Sheet1");
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath(".//*[@id='CustomerForm:mailingCityRowTR']/td[1]/label")));
		//Thread.sleep(2000);
		...
		driver.findElement(By.xpath(".//*[@id='DriverForm:firstUSLicenseAge']")).sendKeys(OpenExcel.getCellData(1, 8));
		driver.findElement(By.xpath(".//*[@id='DriverForm:ageFirstLicensedForeign']")).sendKeys(OpenExcel.getCellData(1, 9));
		Thread.sleep(200);
		...
		driver.findElement(By.xpath(".//*[@id='DiscountsForm:emailAddress']")).sendKeys(OpenExcel.getCellData(1, 10));
